...
public class FutilInsertItemNode extends ASTWrapperPsiElement implements FutilInsertItem {

  public FutilInsertItemNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public FutilInsertStar getInsertStar() {
    return findNotNullChildByClass(FutilInsertStar.class);
  }
