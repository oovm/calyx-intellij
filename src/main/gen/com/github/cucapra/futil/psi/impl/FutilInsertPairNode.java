...
public class FutilInsertPairNode extends ASTWrapperPsiElement implements FutilInsertPair {

  public FutilInsertPairNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public FutilInsertDot getInsertDot() {
    return findChildByClass(FutilInsertDot.class);
  }

  @Override
  @NotNull
  public FutilPair getPair() {
    return findNotNullChildByClass(FutilPair.class);
  }
