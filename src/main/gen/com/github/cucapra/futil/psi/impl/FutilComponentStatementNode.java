...
public class FutilComponentStatementNode extends ASTWrapperPsiElement implements FutilComponentStatement {

  public FutilComponentStatementNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public FutilComponent getComponent() {
    return findNotNullChildByClass(FutilComponent.class);
  }
