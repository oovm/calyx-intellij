...
public class FutilPredefinedSymbolNode extends ASTWrapperPsiElement implements FutilPredefinedSymbol {

  public FutilPredefinedSymbolNode(@NotNull ASTNode node) {
    super(node);
  }
