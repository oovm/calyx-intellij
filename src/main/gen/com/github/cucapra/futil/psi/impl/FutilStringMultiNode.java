...
public class FutilStringMultiNode extends ASTWrapperPsiElement implements FutilStringMulti {

  public FutilStringMultiNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<FutilEscaped> getEscapedList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FutilEscaped.class);
  }
